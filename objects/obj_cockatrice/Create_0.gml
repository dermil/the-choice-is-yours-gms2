...
event_inherited()
//Walking animations
player_animations[0][0] = spr_cockatrice_walking_R; 
player_animations[0][1] = spr_cockatrice_walking_L;
player_animations[0][2] = spr_cockatrice_walking_up;
player_animations[0][3] = spr_cockatrice_walking_down;
