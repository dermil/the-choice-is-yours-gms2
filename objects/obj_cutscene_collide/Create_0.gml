...
//Changes event options based on player direction
up = -1;
down = -1;
left = -1;
right = -1;
...
scene_info[99][0][0] = scr_cutscene_create_textbox;
scene_info[99][0][1] = text_id;

scene_info[99][1][0] = scr_cutscene_end_game;
