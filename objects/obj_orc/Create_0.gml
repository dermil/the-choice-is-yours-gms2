...
//Walking animations
player_animations[0][0] = spr_orc_walking_right; 
player_animations[0][1] = spr_orc_walking_left;
player_animations[0][2] = spr_orc_walking_up;
player_animations[0][3] = spr_orc_walking_down;
